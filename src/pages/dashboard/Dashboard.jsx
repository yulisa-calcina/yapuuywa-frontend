...
const S = {
  hdr:    { marginBottom: 24 },
  title:  { fontFamily:"'Sora',sans-serif", fontSize: 22, fontWeight: 800, color: '#1a3a1a', margin: 0, letterSpacing: '-0.5px' },
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative', padding: '14px 16px' }}>
        ...
        <div style={{ fontSize: 11, color: '#8d9e8d', fontWeight: 500, marginBottom: 4 }}>{label}</div>
        <div style={{ fontFamily: "'Sora',sans-serif", fontSize: 28, fontWeight: 800, color: '#1a3a1a', lineHeight: 1 }}>{val}</div>
    ...
    <div>
      ...
      <div style={S.grid4}>
        ...
        <KpiCard
          ...
          color={alertas.length > 0 ? '#c8a030' : '#2d7a40'}
        />
        <KpiCard
          foto={FOTOS.finanzas}
          icon="💰"
      ...
      <div style={S.grid2}>
        <div style={S.card}>
          <div style={S.cardH}>
            ...
            {alertas.length > 0
              ? <Badge color="red">{alertas.length} urgentes</Badge>
              : <Badge color="green">Sin alertas</Badge>}
          </div>
          {alertas.length === 0
